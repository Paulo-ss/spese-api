...
export class AnalyticsController {
    ...
    public async getExpensesXCategoryReport(
        ...
        return this.analyticsService.getExpensesXCategoryReport(
            filters,
            userId,
        );
    }
    ...
    public async getExpensesXCreditCardsReport(
        ...
        return this.analyticsService.getExpensesXCreditCardsReport(
            filters,
            userId,
        );
    }
    ...
    public async getInvestimentsXMonthReport(
        ...
        return this.analyticsService.getInvestmentsXMonthReport(
            filters,
            userId,
        );
    }
